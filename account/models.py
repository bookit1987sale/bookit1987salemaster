...
class Account(models.Model):
    ...
    main_phone = models.CharField(verbose_name=_('main phone'), max_length=15,
        default='2223334444', 
        blank=True)
    is_manager = models.BooleanField(
        _('manager status'),
        default=False,
        help_text=_('Designates whether the user can interact with other user\'s information.'),
    )
    # reset_password_code = models.PositiveIntegerField(_("reset code"), default=0)
    # password_code_expiry = models.PositiveIntegerField(_("code expire"), default=0)
    ...
    #     # self.password_code_expiry = expiry
    #     return "0000000" #random.randint(100000, 999999)
...
class EmailAddress(models.Model):
    ...
    def create_password_reset_code(self):
        self.reset_password_code = random.randint(100000, 999999)
        self.save()
