...
from source_utils.re_usables import check_phone_options
...
class SignupForm(forms.Form):
    ...
    def clean_phone_number(self):
        ...
        if check_phone_options(value):
            return value
        raise forms.ValidationError(_('Enter a valid phone number\
                                      - ex. 2223334444 or 222-333-4444.'))
    def clean_alt_phone_number(self):
        value = self.cleaned_data["alt_phone_number"]
        if value:
            if check_phone_options(value):
                return value
            raise forms.ValidationError(_('Enter a valid phone number\
...
#         model = Service
#         fields = (
#             "service_branch", "retail_service", "unit_type",
#             "units", "cost", "service_no_longer_available", 
